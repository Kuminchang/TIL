EB%A5%BC-%EC%82%AC%EC%9A%A9%ED%95%98%EB%8A%94-%EB%B0%A9%EB%B2%95)
...
* [02-6 집합 자료형](https://github.com/Kuminchang/TIL#2-6-%EC%A7%91%ED%95%A9-%EC%9E%90%EB%A3%8C%ED%98%95)
...
*  여기서 %s 포맷 코드는 어떤 형태의 값이든 변환해서 넣을 수 있다. 
```python
>>> 'I have %s apples" % 3
'I have 3 apples'
>>> "rate is  %s" % 3.234
...
* 3을 문자열 안에 삽입하려면 %d를 사용해야 하고, 3.234를 삽입하려면 %f를 사용해야 한다. 하지만 %s를 사용하면 이런 것을 생각하지 않아도 된다. %s는 자동으로 % 뒤에 있는 값을 문자열로 바꾸기 때문이다.
...
* 위 예문의 결과값으로 포맷 코드 안에 98이 대입되서 'Error is 98%" 가 출력될꺼라 예상하겠지만 파이썬에서는 값이 올바르지 않다는 값 오류(value Error) 메시지를 보여준다.
...
* 문자열 포맷 코드인 %d와 %가 같은 문자열 안에 존재하는 경우 , %를 나타내려면 반드시 %%로 써야한다는 법칙이 있기 때문이다.
...
* 문자열의 {0} 항목이 number 변수 값인 3으로 바뀐것을 볼 수 있다.
...
* 2개 이상의 값을 넣을 경우 {0},{1}과 같은 인덱스 항목이 format 함수의 입력값으로 순서에 맞게 바뀐다. 즉 위에 예에서 {0}은 format 함수의 첫 번째 입력값인 number로 바뀌고 {1}은 format 함수의 두 번째 입력값인 day로 바뀐다.
...
* format 함수는 인덱스 항복 대신 더 편리한 {name} 형태를 사용하는 방법도 있다. {name} 형태를 사용하는 경우 반드시 name = value 와 같은 형태의 입력값이 있어야만 한다.
...
* 위처럼 f 문자열 포매팅은 name, age와 같은 변수 값을 생성한 후에 그 값을 참조할 수 있다. 또한 f 문자열 포매팅은 표현식을 지원한다.
...
* join 함수는 문자열뿐만 아니라 뒤에 나올 리스트나 튜플도 입력으로 사용가능하다.
...
* split 함수는 문자열을 나눌 때 사용한다. 괄호 안에 아무것도 넣지 않으면 공백(띄어쓰기, 탭)을 기준으로 문자열을 나눈다. 나누어진 값은 리스트의 요소로 저장되는데, 분할된 문자의 개수만큼 각각을 변수로 지정하는 것도 가능하다.

## 2-3 리스트 자료형
# 리스트 사용법
* 리스트를 사용하며 1,3,5,7,9 숫자 모음을 간단히 표현 가능하다.
```python
>>> odd = [1,3,5,7,9]
```

* 리스트를 만들 때는 대괄호 []로 감싸주고 각 요소값은 숨표 (,)로 구분한다.
```python
리스트명 = [요소1,요소2,요소3,...]
```
...
* 리스트는 위에 보이는 것과 같이 숫자형과 문자열을 함께 요소값으로 가질 수도 있으며, e처럼 리스트 자체를 요소값으로 가질 수 있다. 
* 따라서 리스트는 어떠한 자료형도 포함이 가능하다.

* 비어있는 리스트도 생성가능

### 리스트의 인덱싱과 슬라이싱

* 리스트도 문자열처럼 인덱싱과 슬라이싱이 가능하다. 아래에 예시 코드를 먼저 살펴보자.
...
* 위 예시를 살펴보면 리스트의 요소를 불러올 수 있고 ,리스트안에 요소값을 더해서 출력이 가능하다.

* 파이썬은 숫자를 0부터 세기 때문에, a[1]이 리스트 a의 첫 번째 요소가 아니라 a[0]이 리스트의 첫 번째 오소임을 명심하자.
...
* 예상한 대로 a[-1]은 마지막 요소값 ['a','b','c']를 나타낸다. a[3]은 리스트 a의 네번째 요소를 나타내기 때문에 a[-1]과 동일한 결과값을 보여준다.

* 리스트는 인덱싱을 이용해 끄집어낼 수 있다.
```python
>>> a[-1][0]
'a'
```
...
* 위 결과를 살펴보면 2번째 요소안에 2번째 요소안에 0번째 인덱스 값 'Life'를 출력하는 것을 확인할 수 있다.

### 리스트의 슬라이싱
* 앞서 살펴보았던 문자열과 마찬가지로 리스트에서도 슬라이싱 기법을 사용할 수 있다.
...
* 위에 2개의 예시를 살펴보면 완전히 동일하게 사용되었음을 확인할 수 있다.
...
* 위 예시에서 a[3]은 ['a','b','c']를 나타낸다. 따라서 a[3][:2]는 ['a', 'b', 'c']의 첫 번째 요소부터 세 번째 요소 직전까지의 값, 즉 ['a', 'b']를 나타내는 리스트가 된다.

### 리스트 연산하기 
* 리스트 역시 + 기호를 사용해서 더할 수도 있고 , * 기호를 사용해서 반복할 수 있다.
...
* 리스트 사이에서 + 기호는 2개의 리스트를 합치는 기능을 한다. 문자열에서 "abc" + "abcdef"가 되는 것과 같은 이치이다.
...
## 리스트 길이 구하기
* 리스트 길이는 len함수를 사용해야 한다. 예시를 살펴보자.
...
* del a[x]는 x번째 요소값을 삭제한다. 여기서는 a 리스트에서 a[1]을 삭제하는 방법을 보여준다. del 함수는 파이썬이 자체적으로 가지고 있는 삭제 함수이다.

* 다음처럼 슬라이싱 기법으로 리스트의 요소 여러 개를 한꺼번에 삭제할 수도 있다.
...
## 리스트에 요소 추가하기(append)
* 리스트에 요소를 추가하는 append 함수는 리스트의 맨 마지막에 값을 추가하는 함수이다.
...
* 위 예시에서 확인해보면 a가 3이라는 값을 2개 가지고 있을 경우 첫 번째 3만 제거되는 것을 알 수 있다.
...
* pop()은 리스트의 맨 마지막 요소를 리턴하고 그 요소는 삭재한다.
...
* pop 함수를 사용하면 영구적으로 값을 끄집어낼 수 있다.
...
* 튜플은 요솟값 변경이 불가능하기 때문에, sort, insert, remove, pop과 같은 내장 함수가 없다.

## 2-5 딕셔너리 자료형
### 딕셔너리란?

* 딕셔너리는 리스트나 튜플처럼 순차적으로 해당 요소값을 구하지 않고 Key를 통해 Value를 얻는다. 이것이 딕셔너리의 가장 큰 특징이다.
...
* 'name' 문자열은 a 딕셔너리의 Key 중 하나이다. 따라서 'name' in a를 호출하면 참(TRUE)를 리턴한다. 
* 하지만 딕셔너리안에 존재하지 않는 Key를 호출하는 경우엔 False를 리턴한다.

## 2-6 집합 자료형

### 집합 자료형은 어떻게 만들까?
* 집합(set) 함수는 집합에 관련된 것을 쉽게 처리하기 위해 만든 자료형이다.
...
* 위 예시처럼 set()의 괄호 안에 리스트를 입력하여 만들거나 다음과 같이 문자열을 입력하여 만들 수 있다.
...
* 만약 set 자료형에 지정된 값을 인덱싱으로 접근하려면 다음과 같이 튜플이나 리스트로 변환한 후 접근해야 한다.
...
* 교집합은 & 연산자를 이용하면 간단히 구할 수 있다.
* 또는 다음 예시처럼 intersection 함수를 사용해도 동일한 결과를 리턴한다.
...
* 합집합은 | 연산자를 사용한다.
* 다음 예시를 보면 4,5,6 처럼 중복해서 포함된 값은 한 개씩만 표현된다.
...
* 또한 difference 함수를 사용하여 차집합을 구할 수 있다.
...
### 특정 값 제거하기(remove)
* 특정 값을 제거하고 싶다면 remove 함수를 사용하면 된다.
